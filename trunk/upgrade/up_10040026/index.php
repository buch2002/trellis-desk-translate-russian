...
class up_10040026 {
	...
	var $u_ver_id = 10040026;
	var $u_ver_human = 'v1.0 Final';
	...
	function step_1()
	{
		$content = "<div class='groupbox'>Upgrade to ". $this->u_ver_human ."</div>
					<div class='option1'>
						...
						&rsaquo; SMTP Outgoing Email Support<br />
	...
	function step_3()
	{
		...
		$this->ifthd->core->add_cache( 'upgrade', array( '10040026' => array( 'updated_old' => 0, 'new_skin_id' => 0) ) );		
