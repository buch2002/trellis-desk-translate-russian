...
class up_10140041 {
	...
	var $u_ver_id = 10140041;
	var $u_ver_human = 'v1.0.1 Final';

	function auto_run()
	{
		$steps = array( 1 => 'Information', 2 => 'Run SQL Queries', 3 => 'Update Cache', 4 => 'Finish' );
	...
	function step_1()
	{
		$content = "<div class='groupbox'>Upgrade to ". $this->u_ver_human ."</div>
					<div class='option1'>
						...
						&rsaquo; New Piping (and POP3) Features<br />
						&rsaquo; Improved Piping (and POP3) Support<br />
						&rsaquo; Flood Control on Incoming Emails<br />
						&rsaquo; Basic Ticket Search (ACP)<br />
						&rsaquo; Auto-Assign Tickets per Department<br />
						&rsaquo; Javascript Libraries Upgraded<br />
	...
	function step_3()
	{
		...
		$this->ifthd->core->add_cache( 'upgrade', array( '10140041' => array( 'updated_old' => 0, 'new_skin_id' => 0) ) );		
		
		$content = "<div class='groupbox'>Update Cache</div>
